...
import payment.api.tx.accountvalidation.Tx2354Request;
import payment.api.tx.paymentbinding.Tx2512Request;


public class Tx2354 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // 创建交易请求对象
            Tx2354Request tx2512Request = new Tx2354Request();

            tx2512Request.setInstitutionID(institutionID);
            tx2512Request.setTxSN(txSN);
            ...
            request.setAttribute("txCode", "2354");
            request.setAttribute("txName", "企业账户验证查询");  
