...
import payment.api.tx.cb.Tx5551Response;
import payment.api.tx.cb.Tx5552Response;
import payment.api.tx.cb.Tx5553Response;
import payment.api.tx.cb.Tx5554Response;
import payment.api.tx.cb.Tx5555Response;
import payment.api.tx.cb.Tx5556Response;
import payment.api.tx.cb.Tx5557Response;
import payment.api.tx.cb.Tx5558Response;
...
import payment.api.tx.cb.Tx5651Response;
import payment.api.tx.cb.Tx5652Response;
import payment.api.tx.cb.Tx5653Response;
import payment.api.tx.cb.Tx5654Response;
import payment.api.tx.cb.Tx5655Response;
import payment.api.tx.cb.Tx5661Response;
...
import payment.api.tx.cmb.Tx7205Response;
import payment.api.tx.cmb.Tx7206Response;
...
import payment.api.tx.cmb.Tx7301Response;
import payment.api.tx.cmb.Tx7302Response;
...
import payment.api.tx.consumptionfinancial.Tx8279Response;
...
import payment.api.tx.foundationaccount.Tx4602Response;
import payment.api.tx.foundationaccount.Tx4604Response;
import payment.api.tx.foundationaccount.Tx4605Response;
import payment.api.tx.foundationaccount.Tx4631Response;
import payment.api.tx.foundationaccount.Tx4636Response;
import payment.api.tx.foundationaccount.Tx4641Response;
import payment.api.tx.foundationaccount.Tx4643Response;
import payment.api.tx.foundationaccount.Tx4661Response;
import payment.api.tx.foundationaccount.Tx4663Response;
import payment.api.tx.foundationaccount.Tx4681Response;
...
import payment.api.tx.gatheringaccredit.Tx2705Response;
...
import payment.api.tx.gatheringbatch.Tx1660Response;
...
import payment.api.tx.marketorder.Tx1451Response;
import payment.api.tx.marketorder.Tx1452Response;
import payment.api.tx.marketorder.Tx1453Response;
import payment.api.tx.marketorder.Tx1454Response;
import payment.api.tx.marketorder.Tx1458Response;
import payment.api.tx.marketorder.Tx1461Response;
import payment.api.tx.marketorder.Tx1463Response;
import payment.api.tx.marketorder.Tx1471Response;
...
import payment.api.tx.o2o.Tx2241Response;
import payment.api.tx.o2o.Tx2243Response;
import payment.api.tx.o2o.Tx2245Response;
import payment.api.tx.o2o.Tx2246Response;
import payment.api.tx.o2o.Tx2250Response;
...
import payment.api.tx.paymentbatch.Tx1560Response;
...
import payment.api.tx.pos.Tx6050Response;
import payment.api.tx.pos.Tx6051Response;
import payment.api.tx.pos.Tx6052Response;
import payment.api.tx.pos.Tx6053Response;
import payment.api.tx.pos.Tx6071Response;
import payment.api.tx.pos.Tx6072Response;
import payment.api.tx.pos.Tx6073Response;
...
import payment.api.tx.statement.Tx1820Response;
import payment.api.tx.statement.Tx1821Response;
...
import payment.simulator.institution.tx.statement.Tx1810UZip;
 ...
 * jjzhu        2018-03-12  新增4516
 * jjzhu        2018-03-19  新增60系列
 * </pre>
 */
public class SendMessage extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // //交易市场交易
            ...
            }else if ("1451".equals(txCode)) {
                Tx1451Response txResponse = new Tx1451Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            }else if ("1452".equals(txCode)) {
                Tx1452Response txResponse = new Tx1452Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            }else if ("1453".equals(txCode)) {
                Tx1453Response txResponse = new Tx1453Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            }else if ("1454".equals(txCode)) {
                Tx1454Response txResponse = new Tx1454Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            } else if ("1458".equals(txCode)) {
                Tx1458Response txResponse = new Tx1458Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            } else if ("1471".equals(txCode)) {
                Tx1471Response tx1471Response = new Tx1471Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx1471Response.getResponsePlainText());
                if ("2000".equals(tx1471Response.getCode())) {
                    logger.info("[Message]=[" + tx1471Response.getMessage() + "]");
                    // 处理业务
                }
            ...
            } else if ("1560".equals(txCode)) {
                Tx1560Response tx1560Response = new Tx1560Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx1560Response.getResponsePlainText());
                if ("2000".equals(tx1560Response.getCode())) {
                    logger.info("[Message]=[" + tx1560Response.getMessage() + "]");
                    List<SubInstitution> subInstitutionList=tx1560Response.getSubInstitutionList();
                    if (subInstitutionList!=null) {
                    	int size1 = subInstitutionList.size();                     
                    	for(int i = 0; i < size1; i++){
                    		SubInstitution subInstitution=subInstitutionList.get(i);
                    		logger.info("[SubInstitutionID]=[" + subInstitution.getSubInstitutionID() + "]");
                    		List<PaymentItem> itemList=subInstitution.getItemList();                      	
                    		if(itemList!=null){
                    			int size2 = itemList.size();
                    			for (int j = 0; j < size2; j++) {
                    				PaymentItem item = tx1560Response.getItemList().get(j);
                    				logger.info("[BatchNo]=[" + item.getBatchNo() + "]");
                    				logger.info("[TxTime]=[" + item.getTxTime() + "]");
                    				logger.info("[ItemNo]=[" + item.getItemNo() + "]");
                    				logger.info("[BankID]=[" + item.getBankID() + "]");
            ...
            } else if ("1660".equals(txCode)) {
                Tx1660Response tx1660Response = new Tx1660Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx1660Response.getResponsePlainText());
                if ("2000".equals(tx1660Response.getCode())) {
                    logger.info("[Message]=[" + tx1660Response.getMessage() + "]");
                    List<SubInstitution> subInstitutionList=tx1660Response.getSubInstitutionList();
                    if (subInstitutionList!=null) {
                    	int size1 = subInstitutionList.size();                       
                    	for (int i = 0; i < size1; i++) {
                    		SubInstitution subInstitution=tx1660Response.getSubInstitutionList().get(i);
                    		logger.info("[SubInstitutionID]=[" + subInstitution.getSubInstitutionID() + "]");
                    		List<GatheringItem> itemList=subInstitution.getGatheringItemList();
                    		if(itemList!=null){
                    			int size2 = itemList.size();
	                        		for(int j=0;j<size2;j++){
	                        			GatheringItem item = tx1660Response.getGatheringItemList().get(j);
	                        			logger.info("[BatchNo]=[" + item.getBatchNo() + "]");
	                        			logger.info("[TxTime]=[" + item.getTxTime() + "]");
	                        			logger.info("[ItemNo]=[" + item.getItemNo() + "]");
	                        			logger.info("[BankID]=[" + item.getBankID() + "]");
                ...
                if ("2000".equals(txResponse.getCode())) {
                    ...
                    if (txList != null) {
                        ...
                        for (int i = 0; i < size; i++) {
                            ...
                            logger.info("[SplitType]=[" + tx.getSplitType() + "]");
                            logger.info("[SplitResult]=[" + tx.getSplitResult() + "]");
                        }
                    }
                    // 处理业务
                    
                    if(txResponse.getGzipData()!=null){
                    	Tx1810UZip xml = new Tx1810UZip();
                    	String plainText1 = xml.process(txList);
                    	String plainText2 = XmlUtil.createPrettyFormat(XmlUtil.createDocument(plainText1));
                    	request.setAttribute("plainText2", plainText2);
                    }
                }
            ...
            }else if ("1820".equals(txCode)) {
                Tx1820Response txResponse = new Tx1820Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
                	logger.info("[Message]=[" + txResponse.getMessage() + "]");                 
                	List<SubInstitution> subInstitutionList = txResponse.getSubInstitutionList();
                	if (subInstitutionList!=null) {
                		int size1 = subInstitutionList.size();                     
                		for (int i = 0; i < size1; i++) {
                			SubInstitution subInstitution=subInstitutionList.get(i);
                			logger.info("[SubInstitutionID]=[" + subInstitution.getSubInstitutionID() + "]");
                			List<Tx> txList = subInstitution.getTxList();                     	
                			if(txList!=null){
                				int size2 = txList.size();
                				for (int j = 0; j < size2; j++) {
                					Tx tx = txList.get(j);
                					logger.info("[TxType]=[" + tx.getTxType() + "]");
                					logger.info("[TxSn]=[" + tx.getTxSn() + "]");
            ...
            } else if ("1821".equals(txCode)) {
                Tx1821Response txResponse = new Tx1821Response(respMsg[0], respMsg[1]);
            ...
            } else if ("2241".equals(txCode)) {// O2O订单支付退款查询
                Tx2241Response tx2241Response = new Tx2241Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx2241Response.getResponsePlainText());
                if ("2000".equals(tx2241Response.getCode())) {
                    logger.info("[Message]=[" + tx2241Response.getMessage() + "]");
                    // 处理业务
                }
            } else if ("2243".equals(txCode)) {// O2O订单支付退款查询
                Tx2243Response tx2243Response = new Tx2243Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx2243Response.getResponsePlainText());
                if ("2000".equals(tx2243Response.getCode())) {
                    logger.info("[Message]=[" + tx2243Response.getMessage() + "]");
                    // 处理业务
                }
            } else if ("2245".equals(txCode)) {// O2O订单支付退款查询
                Tx2245Response tx2245Response = new Tx2245Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx2245Response.getResponsePlainText());
                if ("2000".equals(tx2245Response.getCode())) {
                    logger.info("[Message]=[" + tx2245Response.getMessage() + "]");
                    // 处理业务
                }
            } else if ("2246".equals(txCode)) {// O2O订单支付退款查询
                Tx2246Response tx2246Response = new Tx2246Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx2246Response.getResponsePlainText());
                if ("2000".equals(tx2246Response.getCode())) {
                    logger.info("[Message]=[" + tx2246Response.getMessage() + "]");
                    // 处理业务
                }
            } else if ("2250".equals(txCode)) {// O2O订单支付退款查询
                Tx2250Response tx2250Response = new Tx2250Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx2250Response.getResponsePlainText());
                if ("2000".equals(tx2250Response.getCode())) {
                    logger.info("[Message]=[" + tx2250Response.getMessage() + "]");
                    // 处理业务
                }
                ...
                if ("2000".equals(tx2911Response.getCode())) {
                    ...
                    request.setAttribute("content", content);
                    String fileType = tx2911Response.getFileType();
            ...
            else if ("4601".equals(txCode)) {//个人开户
                Tx4601Response txResponse = new Tx4601Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            else if ("4602".equals(txCode)) {//个人开户查询
                Tx4602Response txResponse = new Tx4602Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            else if ("4604".equals(txCode)) {//企业开户
                Tx4604Response txResponse = new Tx4604Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            else if ("4605".equals(txCode)) {//企业开户查询
                Tx4605Response txResponse = new Tx4605Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            else if ("4631".equals(txCode)) {//网银充值
                Tx4631Response txResponse = new Tx4631Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
                    ...
                    String form = txResponse.getForm();
            ...
            else if ("4636".equals(txCode)) {//充值查询
                Tx4636Response txResponse = new Tx4636Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            else if ("4641".equals(txCode)) {// 提现
                Tx4641Response txResponse = new Tx4641Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            else if ("4643".equals(txCode)) {//提现查询
                Tx4643Response txResponse = new Tx4643Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            else if ("4661".equals(txCode)) {// 支付账户订单支付
                Tx4661Response txResponse = new Tx4661Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            else if ("4663".equals(txCode)) {//支付账户订单支付查询
                Tx4663Response txResponse = new Tx4663Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            else if ("4681".equals(txCode)) {//用户支付账户信息批量查询
                Tx4681Response txResponse = new Tx4681Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            } else if ("7205".equals(txCode)) {// 建立绑定关系（发送验证短信）
                Tx7205Response tx7205Response = new Tx7205Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx7205Response.getResponsePlainText());
                if ("2000".equals(tx7205Response.getCode())) {
                    logger.info("[Message]=[" + tx7205Response.getMessage() + "]");
                }
            } else if ("7206".equals(txCode)) {// 建立绑定关系（验证并绑定）
                Tx7206Response tx7206Response = new Tx7206Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx7206Response.getResponsePlainText());
                if ("2000".equals(tx7206Response.getCode())) {
                    logger.info("[Message]=[" + tx7206Response.getMessage() + "]");
                }
            ...
            } else if ("7301".equals(txCode)) {
                Tx7301Response txResponse = new Tx7301Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            } else if ("7302".equals(txCode)) {
                Tx7302Response txResponse = new Tx7302Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            } else if("8279".equals(txCode)){
                Tx8279Response txResponse = new Tx8279Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", txResponse.getResponsePlainText());
                if ("2000".equals(txResponse.getCode())) {
            ...
            } else if ("5551".equals(txCode)) { // 跨境进口B2B订单单笔上传
                Tx5551Response tx5551Response = new Tx5551Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5551Response.getResponsePlainText());
            } else if ("5552".equals(txCode)) { // 跨境进口B2B订单单笔查询
                Tx5552Response tx5552Response = new Tx5552Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5552Response.getResponsePlainText());
            } else if ("5553".equals(txCode)) { // 跨境进口B2B订单确认
                Tx5553Response tx5553Response = new Tx5553Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5553Response.getResponsePlainText());
            } else if ("5554".equals(txCode)) { // 跨境进口B2B订单CPCN审核失败
                Tx5554Response tx5554Response = new Tx5554Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5554Response.getResponsePlainText());
            } else if ("5555".equals(txCode)) { // 跨境进口B2B订单撤销
                Tx5555Response tx5555Response = new Tx5555Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5555Response.getResponsePlainText());
            } else if ("5556".equals(txCode)) { // 跨境进口B2B订单指定付款
                Tx5556Response tx5556Response = new Tx5556Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5556Response.getResponsePlainText());
            } else if ("5557".equals(txCode)) { // 跨境进口B2B订单批次查询
                Tx5557Response tx5557Response = new Tx5557Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5557Response.getResponsePlainText());
            } else if ("5558".equals(txCode)) { // 付款批次撤销接口
                Tx5558Response tx5558Response = new Tx5558Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5558Response.getResponsePlainText());
            ...
            } else if ("5651".equals(txCode)) { // 订单付款
                Tx5651Response tx5651Response = new Tx5651Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5651Response.getResponsePlainText());
            } else if ("5652".equals(txCode)) { // 订单查询
                Tx5652Response tx5652Response = new Tx5652Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5652Response.getResponsePlainText());
            } else if ("5653".equals(txCode)) { // 订单查询
                Tx5653Response tx5653Response = new Tx5653Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5653Response.getResponsePlainText());
            } else if ("5654".equals(txCode)) { // 订单查询
                Tx5654Response tx5654Response = new Tx5654Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5654Response.getResponsePlainText());
            } else if ("5655".equals(txCode)) { // 订单查询
                Tx5655Response tx5655Response = new Tx5655Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5655Response.getResponsePlainText());
            } else if ("5661".equals(txCode)) { // 订单查询
                Tx5661Response tx5661Response = new Tx5661Response(respMsg[0], respMsg[1]);
                request.setAttribute("txCode", txCode);
                request.setAttribute("txName", txName);
                request.setAttribute("plainText", tx5661Response.getResponsePlainText());
            ...
            } else if ("2705".equals(txCode)) {
                Tx2705Response tx2705Response = new Tx2705Response(respMsg[0], respMsg[1]);
                setRequestAttribute(request, tx2705Response, txCode, txName);
            ...
            } else if ("6011".equals(txCode)) {//收银支付下单
            ...
            } else if ("6012".equals(txCode)) {//O2O支付下单
            ...
            } else if ("6041".equals(txCode)) {//Pos退货
            ...
            } else if ("6050".equals(txCode)) {//Pos撤销
                Tx6050Response tx6050Response = new Tx6050Response(respMsg[0], respMsg[1]);
                setRequestAttribute(request, tx6050Response, txCode, txName);
            } else if ("6051".equals(txCode)) {//收银支付/O2O支付/轻支付查询
                Tx6051Response tx6051Response = new Tx6051Response(respMsg[0], respMsg[1]);
                setRequestAttribute(request, tx6051Response, txCode, txName);
            } else if ("6052".equals(txCode)) {//Pos撤销查询
                Tx6052Response tx6052Response = new Tx6052Response(respMsg[0], respMsg[1]);
                setRequestAttribute(request, tx6052Response, txCode, txName);
            } else if ("6053".equals(txCode)) {//Pos退货查询
                Tx6053Response tx6053Response = new Tx6053Response(respMsg[0], respMsg[1]);
                setRequestAttribute(request, tx6053Response, txCode, txName);
            } else if ("6071".equals(txCode)) {//线上线下统一对账单
                Tx6071Response tx6071Response = new Tx6071Response(respMsg[0], respMsg[1]);
                setRequestAttribute(request, tx6071Response, txCode, txName);
            } else if ("6072".equals(txCode)) {//线上线下统一对账单
                Tx6072Response tx6072Response = new Tx6072Response(respMsg[0], respMsg[1]);
                setRequestAttribute(request, tx6072Response, txCode, txName);
            } else if ("6073".equals(txCode)) {//线上线下统一对账单
                Tx6073Response tx6073Response = new Tx6073Response(respMsg[0], respMsg[1]);
                setRequestAttribute(request, tx6073Response, txCode, txName);
            }
