...
import payment.api.tx.statement.Tx1821Request;
 ...
 *
 */
public class Tx1821 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // 2.创建交易请求对象
            Tx1821Request txRequest = new Tx1821Request();
            ...
            // //2个信息参数
            request.setAttribute("txCode", "1821");
