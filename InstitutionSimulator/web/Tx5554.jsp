...
<%
    String action = contextPath + "/Tx5554";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">跨境进口B2B订单CPCN审核失败(5554)</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24"><font color="red">*</font>失败原因</td>
        <td width="*" class="content">
            <input type="text" name="FailureReason" size="40" value=""/>
        </td>
    </tr>
</table>
