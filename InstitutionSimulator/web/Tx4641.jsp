...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx4641";
    %>
      ...
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
         ...
         <tr class="mouseout">
          ...
          <tr class="mouseout">
            <td width="120" class="label" height="24"><font color="red">*</font>已绑定银行流水号</td>
            <td width="*" class="content">
          ...
          <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>提现手续费</td>
          <td width="*" class="content">
            <input type="text" name="InstitutionFee" size="40" value="" />
          </td>
          </tr>
         <tr class="mouseout">
...
如：0,1 代表验证通过：短信验证码+交易密码</font>
        ...
        <tr class="mouseout">
            <td width="120" class="label" height="24"></font>备注</td>
            <td width="*" class="content">
      ...
      <input type="hidden" name="TxCode" value="4641" />
    </form>
