...
<script type="text/javascript">
        function showZip(){
    		document.getElementById('uzip').style.display="";
    	}
</script>
...
String plainText2 = (String) request.getAttribute("plainText2");
...
<div id="statement">
      <br />
       <input type="button"  style="width: 99px" value="查看解压报文" onclick="showZip()"></input>
</div>
<table id="uzip" style="display:none" width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr class="mouseout">
        <td width="100" class="label" height="400">响应报文</td>
        <td width="*" class="content">            
            <textarea cols="120" rows="20" wrap="off"><%=plainText2 %></textarea> 
        </td>
    </tr>
</table>
