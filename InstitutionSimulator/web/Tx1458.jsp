...
function doSubmit() {    
    ...
    <%
        String action = contextPath + "/Tx1458";
    %>
    <form action="<%=action%>" name="form1" method="POST">
      <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
        ...
        <tr class="mouseout">
          <td class="label" height="24"><font color="red">*</font>源交易类型</td>
          <td width="*" class="content">
            <select name="SourceTxType" id="SourceTxType" style="width: 274">
              <option value="1451">1451-市场订单O2O支付</option>
              <option value="2241">2241-商户模式O2O支付</option>
            </select>
          </td>
        </tr>
        <tr class="mouseout">
          <td width="120" class="label" height="24"><font color="red">*</font>源交易流水号</td>
          <td width="*" class="content">
        ...
        <tr class="mouseout">
         <td width="120" class="label" height="24"><font color="red">*</font>商户名称</td>
          <td width="*" class="content">
