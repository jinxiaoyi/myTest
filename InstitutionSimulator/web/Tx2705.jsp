...
<%
    String action = contextPath + "/Tx2705";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">协议签署(免认证)(2705)</td>
    </tr>
    ...
    <tr class="mouseout">
        ...
        <td width="*" class="content">
            <input type="text" name="TxSN" placeholder="必填" size="40" value="<%=GUID.genTxNo(25)%>"/>
        </td>
    </tr>
    <tr class="mouseout">
