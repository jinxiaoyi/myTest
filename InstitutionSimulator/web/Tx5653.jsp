...
<%
    String action = contextPath + "/Tx5653";
%>
<form action="<%=action%>" name="form1" method="POST">
<table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" bgcolor="#DDDDDD">
    <tr>
        <td class="head" height="24" colspan="2">订单退款(5653)</td>
    </tr>
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">退款编号</td>
        <td width="*" class="content">
    ...
    <tr class="mouseout">
        <td width="120" class="label" height="24">源交易流水号</td>
        <td width="*" class="content">
            <input type="text" name="SourceSerialNumber" size="40" value=""/>
        </td>
    </tr>

    <tr class="mouseout">
        <td width="120" class="label" height="24">退款原因备注</td>
        <td width="*" class="content">
